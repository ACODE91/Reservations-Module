...
class RestaurantSearch extends React.Component {
 ...
 render(){
  return (
  <div>
  <form className="pickerForm">

    <div className="partySizePicker">
    <select className = "peopleSelector" name="Select_1" tabindex="1">    <option value="1">1 person</option>    
  ...
  <div class="time-picker dtp-picker-selector select-native unselected-on-init">  
  <a class="select-label dtp-picker-selector-link" tabindex="-1">4:30 PM</a>  
        ...
        <option value="09:30">9:30 AM</option>    <option value="10:00">10:00 AM</option>   
         <option value="10:30">10:30 AM</option>    <option value="11:00">11:00 AM</option>   
          ...
          <option value="15:30">3:30 PM</option>    <option value="16:00">4:00 PM</option>   
           ...
           <option value="23:30">11:30 PM</option>  </select></div>
